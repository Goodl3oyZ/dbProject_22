        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 rounded-lg">
            <div
                ...
                <div class="flex flex-col items-center justify-center p-8 text-gray-300">
                    <p class="font-extrabold text-3xl mb-4 text-orange-500">{{ __('Hello, ') . Auth::user()->userName }}
                    </p>
                    <div class="p-4 sm:p-8 mb-6">
                        <div class="flex justify-center">
                            <img src="{{ Auth::user()->profile_photo ? asset('storage/' . Auth::user()->profile_photo) : asset('img/default_profile.png') }}"
                                alt="Profile Photo"
                                class="w-32 h-32 rounded-full border-4 border-orange-500 object-cover shadow-md">
                        </div>
                    </div>
                    <div class="text-center font-semibold text-lg max-w-2xl leading-relaxed text-gray-300">
                        <p>Welcome to <span class="text-orange-500">Human Shop</span>, where we proudly present
                    ...
                    <div class="mt-6 text-lg font-semibold text-orange-500">
